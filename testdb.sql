...
SELECT pg_catalog.setval('public.transaction_tx_id_seq', 1, false);
...
--
-- Name: cart_book fkbsb7y7tgekft18vbhlvmp7lgx; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cart_book
    ADD CONSTRAINT fkbsb7y7tgekft18vbhlvmp7lgx FOREIGN KEY (book_id) REFERENCES public.books(isbn);
